...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.myDiamond = new MyDiamond(this);
        this.myPrism = new MyPrism(this, 8,2);
        this.myCylinder = new MyCilinder(this, 8,2);
        
        this.objects = [this.myPrism, this.pyramid, this.cone, this.plane, this.myUnitCube, this.myTangram];
        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Prism': 0 , 'Pyramid': 1, 'Cone': 2, 'Plane': 3, 'myUnitCube': 4, 'Tangram': 5};
